...
(function () {
  ...
  const MOVE = {
    ...
    serpent: { leash: 0.025, speed: 0.006, turn: 1.3, pause: 0.3, flies: false, shadow: true },
    sac: { leash: 0.045, speed: 0.006, turn: 0.6, pause: 0, flies: true, shadow: true },
    wings: { leash: 0.035, speed: 0.02, turn: 2.6, pause: 0, flies: true, shadow: false },
