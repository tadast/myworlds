...
(function () {
    ...
    },
    {
      key: 'mild', tags: 'temperate', sal: () => 0.35, beats: [
        ...
        ['The weather was the one thing here that never fought us. It is fighting us now.',
          ...
          'The weather turned cold in one night. Whatever season this is, it is over.'],
      ],
    },
    {
    ...
    },
    {
      ...
      beats: [
        ...
        ['{one} has moved the cot into the store room. Nobody has asked {one} to move it back.',
          ...
          '{one} and {two} have split the tools. There are two of everything and there were never two of anything.'],
    ...
    },
    {
      ...
      beats: [
        ...
        ['{one} and {two} built one good pump out of two broken ones. It runs at half the rate.',
          '{one} and {two} have made a pump out of the spare and the old wreck. It is ugly and it works.',
  ...
  const FAUNA_THREADS = pool([
    {
      ...
      beats: [
        ...
        ['{Others} did not come this morning. It is the first day they have missed since day {since}.',
          ...
          'The {kinds} came through at a run today and did not stop. Something moved them.',
    ...
    },
    {
      ...
      beats: [
        ...
        ['{one} walked beside a {kind} for two kilometres today. It let {one} do it the whole way.',
          ...
          '{one} has been feeding a {kind} off the step. It comes to the hand now and takes food gently.'],
    ...
    },
    {
      ...
      beats: [
        ...
        ['The {kind} came through the landing circle at head height. None of us moved and none was touched.',
          'The {kind} has not come for three days. The air over the flat is empty and it is worse.',
    ...
    },
    {
      ...
      beats: [
        ...
        ['Three {kinds} came over the flat today at fifty metres, all going the same way.',
          'The {kinds} hang over the warm ground on the south side and turn slowly. Our {onejob} has film.',
    ...
    },
    {
      ...
      beats: [
        ...
        ['{one} calls the {kind} {pet}. {pet} works the same square of ground most nights.',
          ...
          '{two} named the {kind} {pet} after {pet} came to the plate we put down. That was an answer.'],
        ['{pet} came up at the edge of the circle tonight. We saw the back of it and nothing more.',
          'The ground under the aft leg has given a hand. The {kind} is under there and we know it.',
  ...
  const ENDINGS = pool([
    ...
    { kind: 'ride', w: 4.5, tags: '!leadsecond beasts mwalk leadride', if: g(bigBody), t: 'We are getting on the back of a {kind} in the morning. {two} has the harness finished. It is the only idea any of us has left.' },
    ...
    { kind: 'catch', w: 2, tags: '!leadsecond beasts mwalk', if: g(handBody), t: 'We are catching a {kind} in the morning. {size}, and {one} says two of us can hold that. I do not think {one} is right. We are doing it anyway.' },
    ...
    { kind: 'catch', w: 2, tags: '!leadsecond beasts mdig', t: 'We start the trench at first light, right across the run the {kind} uses. We sit in it until something comes through. {one} has the camera.' },
    ...
    { kind: 'follow', w: 4.5, tags: '!leadsecond beasts mfly leadfollow', t: 'Tomorrow we put the last of the power into the lamp and count the {kinds} that come. {one} wants them all on film. It is not a plan. It is what we want to do.' },
    { kind: 'follow', w: 2, tags: '!leadsecond beasts mfly', t: 'We are following the {kinds} to wherever they go at dusk. {one} has the rover charged. We will not be back before dark and we know it.' },
    { kind: 'follow', w: 2, tags: '!leadsecond beasts mfly', t: 'We are putting a line and a small camera on a {kind} in the morning. {one} has done the knot four times. Tomorrow we find out where they sleep.' },
    ...
    { kind: 'follow', w: 2, tags: '!leadsecond beasts mswarm|mdrift', t: 'Tomorrow {one} and I go out on to the open flat and let the {kind} come over us. We want to be inside it once. That is all.' },
