...
- `ground.js` holds the ground the probe lands on. The globe is a miniature at 1 unit for the planet radius. The ground is true scale: 1 unit is 1 metre. It keeps a second scene, a second camera, and second controls, and it draws with the same renderer. Today it builds a placeholder: a flat plane 1,500 m across in the ground colour, a sky dome of 5,000 m in the atmosphere colour, and fog in the same colour from 450 m to 750 m. Later issues put real terrain, sea, flora, and fauna in it.
